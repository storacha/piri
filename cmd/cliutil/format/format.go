...
const (
	...
	InteractiveFormat OutputFormat = "interactive"
)
...
func ParseOutputFormat(s string) (OutputFormat, error) {
	...
	case "interactive":
		return InteractiveFormat, nil
	default:
		return "", fmt.Errorf("unknown output format: %s (valid formats: table, json, interactive)", s)
	}
}
...
func NewFormatter(format OutputFormat, writer io.Writer) Formatter {
	...
	case TableFormat:
		return &TableFormatter{writer: writer, interactive: false}
	case InteractiveFormat:
		return &TableFormatter{writer: writer, interactive: true}
	default:
		return &TableFormatter{writer: writer, interactive: false}
	}
}
