...
type StorageConfig struct {
	...
	EgressTracking   EgressTrackingStoreConfig
...
// EgressTrackingStoreConfig contains egress tracking store-specific storage paths
type EgressTrackingStoreConfig struct {
	Dir          string
	MaxBatchSize int64
	DBPath       string
}
