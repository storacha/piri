...
func NewService(
	...
	pubCfg := cfg.ExternalServices.Publisher
	...
	return publisher.New(
		...
		publisher.WithIndexingService(cfg.ExternalServices.Indexer.Connection),
		publisher.WithIndexingServiceProof(cfg.ExternalServices.Indexer.Proofs...),
