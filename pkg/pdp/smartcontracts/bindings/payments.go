...
// NETWORKFEE is a free data retrieval call binding the contract method 0x9be5c024.
//
// Solidity: function NETWORK_FEE() view returns(uint256)
func (_Payments *PaymentsCaller) NETWORKFEE(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Payments.contract.Call(opts, &out, "NETWORK_FEE")
...
//
// Solidity: function NETWORK_FEE() view returns(uint256)
func (_Payments *PaymentsSession) NETWORKFEE() (*big.Int, error) {
	return _Payments.Contract.NETWORKFEE(&_Payments.CallOpts)
}

// NETWORKFEE is a free data retrieval call binding the contract method 0x9be5c024.
//
// Solidity: function NETWORK_FEE() view returns(uint256)
func (_Payments *PaymentsCallerSession) NETWORKFEE() (*big.Int, error) {
	return _Payments.Contract.NETWORKFEE(&_Payments.CallOpts)
}
...
// GetRailsForPayeeAndToken is a free data retrieval call binding the contract method 0x2ecfb2bf.
//
// Solidity: function getRailsForPayeeAndToken(address payee, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsCaller) GetRailsForPayeeAndToken(opts *bind.CallOpts, payee common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	var out []interface{}
	err := _Payments.contract.Call(opts, &out, "getRailsForPayeeAndToken", payee, token)

	if err != nil {
		return *new([]PaymentsRailInfo), err
	}

	out0 := *abi.ConvertType(out[0], new([]PaymentsRailInfo)).(*[]PaymentsRailInfo)
...
//
// Solidity: function getRailsForPayeeAndToken(address payee, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsSession) GetRailsForPayeeAndToken(payee common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	return _Payments.Contract.GetRailsForPayeeAndToken(&_Payments.CallOpts, payee, token)
}

// GetRailsForPayeeAndToken is a free data retrieval call binding the contract method 0x2ecfb2bf.
//
// Solidity: function getRailsForPayeeAndToken(address payee, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsCallerSession) GetRailsForPayeeAndToken(payee common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	return _Payments.Contract.GetRailsForPayeeAndToken(&_Payments.CallOpts, payee, token)
}

// GetRailsForPayerAndToken is a free data retrieval call binding the contract method 0x9b85e253.
//
// Solidity: function getRailsForPayerAndToken(address payer, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsCaller) GetRailsForPayerAndToken(opts *bind.CallOpts, payer common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	var out []interface{}
	err := _Payments.contract.Call(opts, &out, "getRailsForPayerAndToken", payer, token)
...
//
// Solidity: function getRailsForPayerAndToken(address payer, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsSession) GetRailsForPayerAndToken(payer common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	return _Payments.Contract.GetRailsForPayerAndToken(&_Payments.CallOpts, payer, token)
}

// GetRailsForPayerAndToken is a free data retrieval call binding the contract method 0x9b85e253.
//
// Solidity: function getRailsForPayerAndToken(address payer, address token) view returns((uint256,bool,uint256)[])
func (_Payments *PaymentsCallerSession) GetRailsForPayerAndToken(payer common.Address, token common.Address) ([]PaymentsRailInfo, error) {
	return _Payments.Contract.GetRailsForPayerAndToken(&_Payments.CallOpts, payer, token)
}
...
//
// Solidity: function settleRail(uint256 railId, uint256 untilEpoch) payable returns(uint256 totalSettledAmount, uint256 totalNetPayeeAmount, uint256 totalOperatorCommission, uint256 finalSettledEpoch, string note)
...
//
// Solidity: function settleTerminatedRailWithoutValidation(uint256 railId) payable returns(uint256 totalSettledAmount, uint256 totalNetPayeeAmount, uint256 totalOperatorCommission, uint256 finalSettledEpoch, string note)
...
// FilterRailOneTimePaymentProcessed is a free log retrieval operation binding the contract event 0x31c2ea9ecc8642f1a3c553226e0839865cbea82b27dcf4b3c63e2c45554c93d9.
//
// Solidity: event RailOneTimePaymentProcessed(uint256 indexed railId, uint256 netPayeeAmount, uint256 operatorCommission)
...
// WatchRailOneTimePaymentProcessed is a free log subscription operation binding the contract event 0x31c2ea9ecc8642f1a3c553226e0839865cbea82b27dcf4b3c63e2c45554c93d9.
//
// Solidity: event RailOneTimePaymentProcessed(uint256 indexed railId, uint256 netPayeeAmount, uint256 operatorCommission)
...
// ParseRailOneTimePaymentProcessed is a log parse operation binding the contract event 0x31c2ea9ecc8642f1a3c553226e0839865cbea82b27dcf4b3c63e2c45554c93d9.
//
// Solidity: event RailOneTimePaymentProcessed(uint256 indexed railId, uint256 netPayeeAmount, uint256 operatorCommission)
...
// FilterRailSettled is a free log retrieval operation binding the contract event 0xe42468614e092798732296ffa7d33bc600fa46894019c210f8d21153b485822d.
//
// Solidity: event RailSettled(uint256 indexed railId, uint256 totalSettledAmount, uint256 totalNetPayeeAmount, uint256 operatorCommission, uint256 settledUpTo)
...
// WatchRailSettled is a free log subscription operation binding the contract event 0xe42468614e092798732296ffa7d33bc600fa46894019c210f8d21153b485822d.
//
// Solidity: event RailSettled(uint256 indexed railId, uint256 totalSettledAmount, uint256 totalNetPayeeAmount, uint256 operatorCommission, uint256 settledUpTo)
...
// ParseRailSettled is a log parse operation binding the contract event 0xe42468614e092798732296ffa7d33bc600fa46894019c210f8d21153b485822d.
//
// Solidity: event RailSettled(uint256 indexed railId, uint256 totalSettledAmount, uint256 totalNetPayeeAmount, uint256 operatorCommission, uint256 settledUpTo)
