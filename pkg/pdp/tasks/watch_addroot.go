...
func NewWatcherRootAdd(db *gorm.DB, pcs *chainsched.Scheduler, contractClient smartcontract.PDP) error {
...
func processPendingProofSetRootAdds(ctx context.Context, db *gorm.DB, contractClient smartcontract.PDP) error {
...
func processProofSetRootAdd(ctx context.Context, db *gorm.DB, rootAdd models.PDPProofsetRootAdd, contractClient smartcontract.PDP) error {
