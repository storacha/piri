...
var HasherRegistry = map[string]func() hash.Hash{
	...
	multicodec.Fr32Sha256Trunc254Padbintree.String(): func() hash.Hash { return &commp.Calc{} },
	multicodec.Sha2_256Trunc254Padded.String():       func() hash.Hash { return &commp.Calc{} },
}
