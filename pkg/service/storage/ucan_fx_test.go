...
func TestFXServer(t *testing.T) {
	...
	appConfig := testutil.NewTestConfig(t, testutil.WithSigner(testutil.Alice))
...
func TestFXReplicaAllocateTransfer(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			appConfig := testutil.NewTestConfig(t,
				testutil.WithSigner(testutil.Alice),
				testutil.WithUploadServiceURL(uploadServiceURL),
			)
