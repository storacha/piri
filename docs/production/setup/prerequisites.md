...
### Lotus Node Setup
A [Lotus node](https://github.com/filecoin-project/lotus) is required for interacting with the PDP Smart Contract deployed on the Filecoin [Mainnet](https://docs.filecoin.io/networks/mainnet).

**Requirements:**
- Latest Mainnet [Snapshot](https://forest-archive.chainsafe.dev/latest/mainnet/)
...
Example output: `f410folmdl6rosnw33ll7bgx72ans76auan24ubjsc4y`

**Step 2: Fund the Address**

1. Use an exchange or existing wallet to send funds to the address you created
2. Verify funding:
