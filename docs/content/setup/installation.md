...
Download the latest release from [v0.2.2](https://github.com/storacha/piri/releases/tag/v0.2.2):

### For Linux AMD64
```bash
wget https://github.com/storacha/piri/releases/download/v0.2.2/piri_0.2.2_linux_amd64.tar.gz
...
### For Linux ARM64
```bash
wget https://github.com/storacha/piri/releases/download/v0.2.2/piri_0.2.2_linux_arm64.tar.gz
